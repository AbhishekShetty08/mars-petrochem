...
<li class="active"><a href="contact-us.php#contact-us">CONTACT</a></li>
</ul>
...
<div id="contact-us" class="float dark-green">
<div class="auto2">
<div class="auto">
<div class="float">
...
<div class="left grid6 mt25 ">
<p class="content">
<strong>Address (Mumbai) :</strong><br />
Mars Petrochem Pvt Ltd
25. Jackeria Bunder Road,<br />
Next To Bank Of Maharashtra,
Cotton Green (W), <br />
Mumbai 400033. <br />
<strong>Tel :</strong>
+91-22-65505615/ 07/08 /+91-22-23723836 <br />
<strong>Email :</strong>
info@marspetrochem.com 
</p>
<a class="map-btn clr" href="google-map.php#map">Locate Us On Google map</a>
<br />
<br />
<p class="content clr">
<strong>Branch-Office(Vapi) :</strong><br />
169, Amidhara Complex,<br >
1st Floor Next to C N G Pump,
G.I.D.C. Char Rasta,<br />
National Highway No. 8,
Vapi 396 195. Gujarat<br />
<strong>Tel :</strong>
+91-260-2401799 <br />
<strong>Email :</strong>
info@marspetrochem.com 
...
<br />
<p class="content">
<strong>Vapi Depot :</strong><br />
C/1/B/12, G.I.D.C Estate,Phase 1, <br />
 Opp Centre of Excellence,
Opp Smit Writing,<br />
G.I.D.C. Vapi 396 1965, Gujarat.

<br />
<br />
<p class="content mb40">
<strong>Baroda :</strong><br />
25/26, Saujanya Complex, 
Near Billa Bong School, <br />
Near Vadsar Bridge, 
Vadsar, Baroda 390 010, Gujarat.<br />
<strong>Tel :</strong>
+09374053392
</p>
</div>

<div class="left mt25 grid6">
<strong><p class="content">Write Us :</p></strong>
<div class="contact-form content mt15">

<form id="contact-form" action="contact.php" method="POST" enctype="multipart/form-data">
<div class="float">
<p>Name</p>
<input type="text" id="name" name="name" allow="character" required />
</div>
<div class="float">
<p>Email</p>
...
<div class="float">
<p>Contact No.</p>
<input type="text" id="contact" name="contact" allow="number" maxlength="10" required />
</div>
<div class="float">
<p>Message</p>
<textarea id="message" name="message" cols="" rows="3" required></textarea>
</div>

<div class="float">
<input id="submit" name="submit" class="submit" type="submit" value="Submit" />
</div>
<p class="display" id="thankyou">Thank You Guest. Your form has been submitted.</p>
</form>
</div>
</div>
...
<li><a href="gallery.php#gallery">Gallery</a></li>
<div class="float divider"></div>
<li class="active2"><a href="contact-us.php#contact-us">Contact</a></li>
</ul>
</div>
