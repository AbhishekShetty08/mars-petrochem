        ...
        <form role="form">
            ...
            <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="testimonial" id="InputMessage" class="form-control" rows="5" required>                   
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="InputMessage">Testimonial</label>
                    <div class="input-group">
                        <textarea name="testimonial" id="InputMessage" class="form-control" rows="5" required></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="InputName" id="InputName" placeholder="Author Name" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
