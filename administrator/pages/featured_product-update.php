        ...
        <form role="form">
            ...
            <div class="form-group">                  
                    <div class="input-group">
                        <input type="hidden" class="form-control" name="id" id="InputName" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="InputMessage">Enter Details</label>
                    <div class="input-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="url" class="form-control" name="InputName" id="InputName" placeholder="Enter URL" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
