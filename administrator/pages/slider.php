...
<head>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <form role="form" action="../process/slider/slider.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-6">
            
                <div class="form-group">
                    <label for="InputName">Upload Image</label>
                    <div class="input-group">
                        <input type="file" name="image" id="InputName" placeholder="Upload Image" required>
                    </div>
                </div>
