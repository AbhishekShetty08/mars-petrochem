...
<head>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="distributor-logo.php">Distributor Logo</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        <form role="form" action="../process/distributor-logo/distributor-logo.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-6">
            
                <div class="form-group">
                    <label for="InputName">Upload Image</label>
                    <div class="input-group">
                        <input type="file" name="files" id="InputName" placeholder="Upload Image" required>
                    </div>
                </div>
