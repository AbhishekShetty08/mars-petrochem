...
<![endif]-->
<meta charset="utf-8">
<title>Mars Petrochem Pvt Ltd | Awards</title>
...
<div id="awards" class="float dark-green">
<div class="auto2">
<div class="auto">
<div class="float">
...
<p class="content mb20 font underline"><strong>Awards and Accolades</strong></p>
<!--<div class="float">
...
<div class="float">
<p class="content mb20"><strong></strong></p>
</div>
...
<div class="container mt30 mb40">
			...
			<ul class="image-row">
				<li class="image-set">
					<a class="example-image-link" href="images/awards1.jpg"data-lightbox="example-set" ><img class="example-image" src="images/award-thumb1.jpg" /></a>
                    <div class="info">
                    <span class="name"><b>SSA Toppers' Convention-2010</b></span><br />
                    </div>
                    </li>
					<li class="image-set">
					<a class="example-image-link" href="images/awards2.jpg" data-lightbox="example-set" ><img class="example-image" src="images/award-thumb2.jpg" /></a>
                    <div class="info">
                    <span class="name"><b>ExxonMobil</b></span><br />
                    </div>
                    </li>
					<li class="image-set">
					<a class="example-image-link" href="images/awards4.jpg" data-lightbox="example-set" ><img class="example-image" src="images/award-thumb4.jpg" /></a>
                    <div class="info">
                    <span class="name"><b>ExxonMobil</b></span><br />
                    </div>
                    </li>
					...
					<li class="image-set">
					<a class="example-image-link" href="images/awards3.jpg" data-lightbox="example-set" ><img class="example-image" src="images/award-thumb3.jpg" /></a>
                    <div class="info">
                    <span class="name"><b>Circle of Excellence Winner</b></span><br />
                    </div>
                    </li>
