...
<![endif]-->
<meta charset="utf-8">
<title>Mars Petrochem Pvt Ltd | Events</title>
...
<div id="events" class="float dark-green">
<div class="auto2">
<div class="auto">
<div class="float">
...
<p class="content mb20 font underline"><strong>Events</strong></p>

<div id='tab1' class="tab1">
<div class="container mt30 mb40">

			<ul class="image-row" style="position:relative;">
				<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb1.jpg" /></a>
                    <div class="info">
					...
					<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb2.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
					...
					<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb3.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
					...
					<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb4.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
                    ...
                    <li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb5.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
					...
					<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb6.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
					...
					<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb7.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
					...
					<li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb8.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
                    ...
                    <li class="image-set">
					<a class="example-image-link" href="events-page.php#events-page" data-lightbox="example-set" ><img class="example-image" src="img/thumb9.jpg" /></a>
                    <div class="info">
                    <span class="name">Event Name</span><br />
                    <span class="date ">24 June 2015</span>
                    </div>
